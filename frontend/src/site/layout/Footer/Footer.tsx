        ...
        <div className={styles.container}>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contact}>
              ...
              <span className={styles.email}>venture@venture-online.com</span>
            </div>
            ...
            <div className={styles.contact}>
              ...
              <span className={styles.phone}>0120-4881000-49</span>
            </div>
            ...
            <div className={styles.contact}>
              ...
              <span className={styles.location}>W53D & W54H, Sector 11, Noida, Uttar Pradesh – 201301</span>
            </div>
          </div>
